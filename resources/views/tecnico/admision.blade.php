<x-app-layout>
    <div class="max-w-5xl  mx-auto px-2 sm:px-6 lg:px-4 pt-6">
        ...
        <div class="max-w-5xl bg-white rounded-lg shadow-lg mx-auto px-4 py-2 sm:px-6 lg:px-8 mt-3">
            ...
            <a type="button" href="{{ route('infbase.index', $tramite) }}"
                class="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-bold rounded-lg text-sm px-5 mx-3 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><i
                    class="fa-solid fa-file-import text-white mr-1"></i>Inf. Base</a>
            ...
            <a type="button" href="{{ route('admision.index', $tramite) }}"
                class="focus:outline-none text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-bold rounded-lg text-sm px-5 mx-3 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><i
                    class="fa-solid fa-file-pen text-white mr-1"></i>Admisión</a>
        ...
        @if ($tramite->status > 1)
            @livewire('tecnico.show-itu', ['tramite' => $tramite], key($tramite->id))
            ...
            <div class="flex bg-white rounded-lg shadow-lg px-12 py-4 mb-4 items-center w-auto">
                ...
                <div class="text-blue-600">
                    <span class="font-bold text-lg text-blue-500">
                        No se encuentra habilitada la etapa de Admisión.
                    </span>
                </div>
            </div>
        @endif
