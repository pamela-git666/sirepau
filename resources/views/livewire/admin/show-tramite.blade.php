                            ...
                            <tr>
                                ...
                                <td class="px-2 py-4 ">
                                    <div class="flex items-center">
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">
                                                {{ $tramite->tecnico->nombres }} {{ $tramite->tecnico->apellidos }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
    ...
    <x-jet-dialog-modal wire:model="open_edit">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <select
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    wire:model="tramite.tecnico_id">
                    <option class="hidden" value="">Seleccione un Técnico</option>
                    @foreach ($tecnicos as $tecnico)
                        <option value="{{ $tecnico->id }}">{{ $tecnico->nombres }} {{ $tecnico->apellidos }}
                        </option>
                    @endforeach
                </select>
                <x-jet-input-error for="tramite.tecnico_id" />
            </div>
