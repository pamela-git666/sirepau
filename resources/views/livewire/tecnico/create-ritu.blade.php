<div class="ml-auto">
    <x-button-enlace class="pulse_boton cursor-pointer" wire:click="$set('open',true)">
        <i class="fa-solid fa-file-arrow-up mr-2"></i> Subir Ritu
    </x-button-enlace>
    <x-jet-dialog-modal wire:model="open">
        <x-slot name="title">
            RITU (Revisión de Informe Técnico Urbano)
        </x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                <x-jet-label value="N° de Cite del Informe (MPR/VA/DGA/UAUyM IT_RITU N°065/2023) " />
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full  mb-2" wire:model="nombre" />
