<div class="ml-auto">
    <x-button-enlace class="pulse_boton cursor-pointer" wire:click="$set('open',true)">
        <i class="fa-solid fa-file-arrow-up mr-2"></i> Subir Información Base 
    </x-button-enlace>
    <x-jet-dialog-modal wire:model="open">
        <x-slot name="title">
           SOLICITUD INFORMACIÓN BASE
        </x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full  mb-2" wire:model="numcite" />
                <x-jet-input-error for="numcite" />
            </div>
