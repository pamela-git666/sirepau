<div class="ml-auto">
    <x-button-enlace class="pulse_boton cursor-pointer" wire:click="$set('open',true)">
        <i class="fa-solid fa-file-arrow-up mr-2"></i> Subir Resolución
    </x-button-enlace>
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                <x-jet-label value="N° de Cite del Informe (AD N°030/2023)" />
                <x-jet-input type="text" class="w-full  mb-2" wire:model="numruta" />
                <x-jet-input-error for="numruta" />
            </div>

           {{-- <div class="mb-4">
                <x-jet-label value="N° Hoja de Resolución (12259)" />
                <x-jet-input type="text" class="w-full  mb-2" wire:model="numresolucion" />
                <x-jet-input-error for="numresolucion" />
            </div>--}}
