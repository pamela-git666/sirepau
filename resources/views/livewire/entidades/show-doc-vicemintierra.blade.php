    ...
    <x-modal-simple wire:model="open">
        ...
        <x-slot name="content">
            ...
            <div class="w-full h-auto">
                <iframe class="w-full" style="height: 460px" src="{{ Storage::url($vicemintierra->archivo) }}"
