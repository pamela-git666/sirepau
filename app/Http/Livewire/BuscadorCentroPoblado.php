...
class BuscadorCentroPoblado extends Component
{
    ...
    public $open_info = false;
    public $tramite;

    
    protected $listeners = ['render'];

    public function info(Tramite $tramite)
    {
        $this->open_info = true;
    ...
    public function render()
    {
        ...
        if ($this->selectedDepartamento && $this->selectedProvincia && $this->selectedMunicipio && $this->search) {
            ...
            return view('livewire.buscador-centro-poblado',compact('departamentos','se','tramits'));
        }
        elseif($this->selectedDepartamento && $this->selectedProvincia && $this->selectedMunicipio) {
            ...
            $tramits = null;
                ...
                return view('livewire.buscador-centro-poblado',compact('departamentos','tramits')); 
      
        }
        return view('livewire.buscador-centro-poblado');
    }
