...
class CreateVicemintierra extends Component
{
    use WithFileUploads;
    public $open = false;
    ...
    public function save()
    {
        $this->validate();
        if ($this->archivo) {
            $archivo = $this->archivo->store('public/vicemintierra');

            Vicemintierra::create([
    ...
    {
        return view('livewire.entidades.create-vicemintierra');
    }
}
